<!--
  AGENTS.md
  The first thing any AI assistant should read when opening this project.
  Tool-agnostic name — read by Cursor, Claude, Sourcegraph, and most modern AI coding tools by default.
  Keep this short. Pointers, not content. Real content lives in docs/.
-->

# If Walls Could Talk Website — AI Instructions

## What this project is
A static **Astro + Tailwind CSS** site for **If Walls Could Talk LLC**, a painting company serving Brevard County, Florida. Owner: Heather, who runs the company remotely from Da Nang, Vietnam. Hosted on Netlify, version-controlled on GitHub.
...
- Break work into small steps and pause for OK between them.
- Add a comment at the top of every code file explaining what it does.
